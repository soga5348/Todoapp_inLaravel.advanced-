...
<head>
  ...
  <meta name="csrf-token" content="INJOyd1XvpHwKs6aAn9yW8G2RtWVhfEcqpwgdiAf">
  <style>
    html,
body,
div,
...
<div class="todo">
  <form action="http://54.65.181.123/todo-advance/todo/create" method="post" class="flex between mb-30">
    <input type="hidden" name="_token" value="INJOyd1XvpHwKs6aAn9yW8G2RtWVhfEcqpwgdiAf">    <input type="text" class="input-add" name="content" />
